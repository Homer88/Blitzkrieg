...
class CBridgeSpan;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef stdext::hash_map<CLinkObject*, SMapObjectInfo::SLinkInfo, SUniqueIdHash> LinkInfo;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class CAILogic : public IAILogic
{
	...
	typedef stdext::hash_set<CGDBPtr<SMechUnitRPGStats>, SDefaultPtrHash> CAvailTrucks;
...
public:
	...
	void InitStartCommands( const LinkInfo &linksInfo, stdext::hash_map<int, int> &old2NewLinks );
	void InitReservePositions( stdext::hash_map<int, int> &old2NewLinks );

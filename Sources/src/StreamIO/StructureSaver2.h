...
class CStructureSaver2 : public IStructureSaver
{
	...
	typedef stdext::hash_set<IRefCount*, SDefaultPtrHashCompare> CPObjectsHashSet;
	...
	stdext::hash_set<IRefCount*, SDefaultPtrHashCompare> objset;

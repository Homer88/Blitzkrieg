...
typedef stdext::hash_set<int> CIntHash;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//*******************************************************************
//*												  CStaticObjects													*
//*******************************************************************
...
private:
	...
	typedef stdext::hash_map< int, CPtr<IObstacle> > ObstacleObjectMap;
...
public:
	...
	class CStoragesContainer
	{
		...
		typedef stdext::hash_map< CObj<CBuildingStorage>, bool, SUniqueIdHash > CStorages;
...
public:
	...
	typedef stdext::hash_set< CObj<CExistingObject>, SUniqueIdHash > CObjectsHashSet;
	CObjectsHashSet terraObjs;
	CObjectsHashSet deletedObjects;
	std::list< CPtr<CStaticObject> > unregisteredObjects;

	stdext::hash_set<int> burningObjects;

...
class CRailroad : public CSplineEdge
{
	...
	stdext::hash_map< CPtr<CEdgePoint>, int, SDefaultPtrHash > intersectionPointToGraphNode;
public:
...
class CRailroadGraph : public CGraph
{
	...
	stdext::hash_map< DWORD, CObj<IEdge> > edges;
	std::vector< CObj<CEdgePoint> > edgeNodes;

	//
	void LookForPoint( const int v, const CVec2 &vDir, stdext::hash_set<int> *pVisitedPoints, std::list<SPointInfo> *pPointsList );
	// ���������� v2 �����, ��� ����� � ����� � ������������ vDir ��� �������� �� ����� ( v, v2 ) � dir ��� ��� ����� ����� � vDir
	// ���� v2 �� �������, �� ���������� -1
	void GetMovablePoint( const int v, const CVec2 &vDir, stdext::hash_set<int> *pVisitedPoints, std::list<SPointInfo> *pPointsList );
public:

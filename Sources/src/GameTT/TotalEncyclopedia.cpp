...
{
	std::for_each( units.begin(), units.end(), [](CUnitInfoItem* item) {
		if (item) item->ApplyUpgrades();
	});
	// fuck
	return 0;
}
...
{
	std::for_each( classes.begin(), classes.end(), [](CUnitClassInfo* cls) {
		if (cls) cls->ApplyUpgrades();
	});
	return 0;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

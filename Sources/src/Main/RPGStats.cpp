...
{ 
	...
	// shell types
	std::for_each( shells.begin(), shells.end(), [](auto& obj) { obj.ToAIUnits(); } ); 
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void STerraObjSetRPGStats::ToAIUnits()
{
	...
	std::for_each( segments.begin(), segments.end(), [](auto& obj) { obj.ToAIUnits(); } );
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool SBuildingRPGStats::Validate()
{
	...
	//
	std::for_each( slots.begin(), slots.end(), [](auto& obj) { obj.Validate(); } );
	//
	return true;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void SBuildingRPGStats::ToAIUnits()
{
	...
	//
	std::for_each( entrances.begin(), entrances.end(), [](auto& obj) { obj.ToAIUnits(); } );
	std::for_each( slots.begin(), slots.end(), [](auto& obj) { obj.ToAIUnits(); } );
	std::for_each( firePoints.begin(), firePoints.end(), [](auto& obj) { obj.ToAIUnits(); } );
	std::for_each( smokePoints.begin(), smokePoints.end(), [](auto& obj) { obj.ToAIUnits(); } );
	std::for_each( dirExplosions.begin(), dirExplosions.end(), [](auto& obj) { obj.ToAIUnits(); } );
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ************************************************************************************************************************ //
// **
...
void SUnitBaseRPGStats::ToAIUnits()
{
	...
	std::for_each( aabb_as.begin(), aabb_as.end(), [](auto& obj) { obj.ToAIUnits(); } );
	std::for_each( aabb_ds.begin(), aabb_ds.end(), [](auto& obj) { obj.ToAIUnits(); } );
	//
...
void SMechUnitRPGStats::ToAIUnits()
{
	...
	// armor
	std::for_each( &(armors[0]), &(armors[6]), [](auto& obj) { obj.ToAIUnits(); } ); 
	// ������������������� min/max Armor
	{
	...
	//
	std::for_each( platforms.begin(), platforms.end(), [](auto& obj) { obj.ToAIUnits(); } );
	//
	if ( nPriority == 0 )
		nPriority = 1;
	//
...
{
	SStaticObjectRPGStats::ToAIUnits();
	std::for_each( stats.begin(), stats.end(), [](auto& obj) { obj.ToAIUnits(); } );
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
	std::for_each( order.begin(), order.end(), [](auto& obj) { obj.ToAIUnits(); } ); 
	return true;
}
void SSquadRPGStats::ToAIUnits()
{
	SHPObjectRPGStats::ToAIUnits();
	std::for_each( formations.begin(), formations.end(), [](auto& obj) { obj.ToAIUnits(); } ); 

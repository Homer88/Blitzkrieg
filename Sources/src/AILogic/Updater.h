...
private:
	typedef stdext::hash_map< int, int> CAnimationSet;

	typedef stdext::hash_map< int, SSimpleUpdate> CSimpleUpdatesSet;
	typedef stdext::hash_map< int, CObj<IUpdatableObj> > CComplexUpdatesSet;

...
void CRailroadGraph::GetClosestPoints( const CVec2 &vPoint, std::list< CPtr<CEdgePoint> > *pPoints, float *pfMinDist, const int vConnectionNode, const float fTolerance )
{
	*pfMinDist = -1.0f;
	...
	for ( stdext::hash_map< DWORD, CObj<IEdge> >::iterator iter = edges.begin(); iter != edges.end(); ++iter )
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CRailroadGraph::LookForPoint( const int v, const CVec2 &vDir, stdext::hash_set<int> *pVisitedPoints, std::list<SPointInfo> *pPointsList )
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CRailroadGraph::GetMovablePoint( const int v, const CVec2 &vDir, stdext::hash_set<int> *pVisitedPoints, std::list<SPointInfo> *pPointsList )
{
...
CEdgePoint* CRailroadGraph::MakeIndent( const CVec2 &vDir, CEdgePoint *pPoint, const float fDist )
{
	...
	else
	{
		...
		stdext::hash_set<int> visitedPoints;

...
void CAILogic::LoadAvailableTrucks()
{
	...
	if ( pChapterStats )
	{
		...
		{
			stdext::hash_set<std::string> availiableUnits;
			if ( context.GetAvailiableUnits( 0, RPG_TYPE_TRN_CARRIER, &availiableUnits ) > 0 )
			{
				for ( stdext::hash_set<std::string>::const_iterator unitIterator = availiableUnits.begin(); unitIterator != availiableUnits.end(); ++unitIterator )
				{
...
void CAILogic::InitLinks( LinkInfo &linksInfo )
{
	...
	// �����, ������� ��������� � �����
	stdext::hash_map<int, int> nextCarriages;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CAILogic::InitStartCommands( const LinkInfo &linksInfo, stdext::hash_map<int, int> &old2NewLinks )
{
	for ( SLoadMapInfo::TStartCommandsList::const_iterator iter = startCmds.begin(); iter != startCmds.end(); ++iter )
	{
		if ( !iter->unitLinkIDs.empty() )
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CAILogic::InitReservePositions( stdext::hash_map<int, int> &old2NewLinks )
{
	for ( SLoadMapInfo::TReservePositionsList::const_iterator iter = reservePositions.begin(); iter != reservePositions.end(); ++iter )
	{
